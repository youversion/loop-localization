...
- `scripts/crowdin_sync.py` — pulls current source strings from Crowdin
  (default mode) or pushes new local strings to Crowdin (`--push`). Runs on
  Bitrise; see the script's docstring for the three modes.
